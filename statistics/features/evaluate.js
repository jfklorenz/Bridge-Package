function evaluate() {
  var spades = parseInt(document.getElementById("NumberA").value);
  var hearts = parseInt(document.getElementById("NumberB").value);
  var diamonds = parseInt(document.getElementById("NumberC").value);
  var clubs = parseInt(document.getElementById("NumberD").value);
  var s = 0;
  var h = 0;
  var d = 0;
  var c = 0;
